...
#+begin_src emacs-lisp
  ...
  (setq org-capture-templates
  	...
  	("wa" "Add a work appointment" entry (file+olp "" "work" "appointments") "* SCHE %?\nSCHEDULED: %^T")
          ("tw" "Schedule a work TODO" entry (file+olp "" "work" "todos") "* TODO %?")
  	...
  	("o" "Add an \"other\" type of item")
  	("oa" "Schedule ao \"other\" appointment" entry (file+olp "" "other" "appointments") "* SCHE %?\nSCHEDULED: %^T")
  	("ot" "Add a \"other\" todo" entry (file+olp "" "other" "todos") "* TODO %?\n- State \"TODO\"\n%U")))
#+end_src
...
#+begin_src emacs-lisp
  (setopt org-agenda-category-icon-alist
  	`(("parenting" ,(list (all-the-icons-faicon "users" :width 2)))
  	  ...
  	  ("other" ,(list (all-the-icons-faicon "question-circle" :width 2)))))
